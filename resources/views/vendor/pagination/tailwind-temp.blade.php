    ...
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}"
        ...
        <div class="flex flex-1 justify-between sm:hidden">
            @if ($paginator->onFirstPage())
                {{-- <span
                    class="inline-flex relative items-center px-4 py-2 text-sm font-medium leading-5 text-gray-500 rounded-md border border-gray-300 cursor-default">
            ...
            @else
                {{-- <a href="{{ $paginator->previousPageUrl() }}"
                    class="inline-flex relative items-center px-4 py-2 text-sm font-medium leading-5 text-gray-700 rounded-md border border-gray-300 ring-gray-300 transition duration-150 ease-in-out hover:text-gray-500 focus:outline-none focus:ring focus:border-blue-300 active:bg-gray-100 active:text-gray-700">
                    {!! __('pagination.previous') !!}
                </a> --}}
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div>
                <p class="text-user-sm leading-5 text-gray-700">
                    {!! __('Showing') !!}
