          ...
          <div class="w-full overflow-x-auto">
              ...
              <form
                  ...
                  <label class="block text-sm w-full md:w-1/2 md:pr-2">
                      ...
                      <input
                          class="block w-full mt-1 text-sm rounded-sm @error('title') border-red-600 focus:border-red-400 @enderror focus:outline-none focus:shadow-outline-purple form-input"
                          placeholder="Masukkan judul materi" name="title" value="{{ $article->title }}" />
                      @error('title')
